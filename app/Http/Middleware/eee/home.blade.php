                    ...
                    width="100%" height="auto"> --}}
                        ...
                        <div class="card-body px-3">
                            <p class="campaign-text">{{trans('middle_east_office.some_babies_are_born_blind,_yet_poor,_some_do_not_have_access_to_basic_education,_others_cannot_afford_a_pair_of_shoes,_some_drink_contaminated_water,')}} <br>
                                ...
                                {{trans("middle_east_office.in_a_world_where_others_throw_enough_food_into_the_dustbin_others_cain't_just_afford_a_single_meal_per_day._remember_to_who_tries_to_give_happiness_to_others_hapiness_is_also_added_to_his_life._join_our_community_of_monthly_donators_today._make_a_change_today")}}</p>
                            <div>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <textarea style="height: 100px!important;" class="form-control" rows="2" name="message"
                                    placeholder="Name and Message" required></textarea>
                            </div>
                        </div>
                        <div class="my-3">
                        ...
                        <form action="{{ url('contact') }}" method="post" role="form" class="php-email-form">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="reason" id="reason"
                                    placeholder="Reason of Contact" required>
                            </div>
                            <div class="form-group mt-3">
